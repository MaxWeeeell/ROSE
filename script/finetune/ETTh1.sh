...
python -u ROSE_finetune.py \
    ...
    --seed 2023 >logs/LongForecasting/$model_type/$dset/$model_type'_'$dset'_tw96'.log 
...
python -u ROSE_finetune.py \
    ...
    --model_type $model_type\
    --finetune_percentage 1\
    --seed 2021 >logs/LongForecasting/$model_type/$dset/$model_type'_'$dset'_tw192'.log 
...
python -u ROSE_finetune.py \
    ...
    --model_type $model_type\
    --finetune_percentage 1\
    --seed 2021 >logs/LongForecasting/$model_type/$dset/$model_type'_'$dset'_tw336'.log 
...
python -u ROSE_finetune.py \
    ...
    --model_type $model_type\
    --finetune_percentage 1\
    --seed 2023 >logs/LongForecasting/$model_type/$dset/$model_type'_'$dset'_tw720'.log 