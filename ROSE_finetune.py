...
from src.learner_pvq import Learner
...
parser.add_argument('--n_epochs_freeze', type=int, default=30, help='number of finetuning epochs')
...
parser.add_argument('--finetune_percentage', type=float, default=0.1, help='percentage of the train_set')
parser.add_argument('--one_channel', type=int, default=0, help='choose 1 channel')
parser.add_argument('--seed', type=int, default=2021, help='choose 1 channel')
...
def finetune_func(lr=args.lr):
    ...
    # fit the data to the model
    learn.fine_tune(n_epochs=args.n_epochs_finetune, base_lr=lr, freeze_epochs=args.n_epochs_freeze, freeze_embedding=args.freeze_embedding)
...
if __name__ == '__main__':
    ...
    for i in range(1):
        if args.is_finetune:
            ...
            args.dset = args.dset_finetune
            weight_path = args.save_path+args.dset_finetune+'_rose_finetuned'+suffix_name
            # Test
